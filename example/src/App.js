  ...
  const examples = [
    {
      title: 'Basic Usage',
      url: '/basic',
      text: 'How to use the component to render an array of vtkVolumes and manipulate their RGB Transfer Functions.'
    },
    {
      title: 'Image Fusion',
      url: '/fusion',
      text: 'Demonstrates how to display two volumes simultaneously with different transfer functions for PET/CT Fusion.'
    },
    {
      title: 'Image Segmentation via Paint Widget',
      url: '/painting',
      text: 'Demonstrates how to enable the painting tools in both 2D and 3D views of the data. Image data for the underlying labelmap is rendered in both components simultaneously.'
    },
    {
    ...
    <div className="container">
      ...
      <div className="row">
        <div className='col-xs-12 col-lg-6'>
          <h4>What is this?</h4>
          <p>This is a set of re-usable components for displaying data with <LinkOut href={"https://github.com/Kitware/vtk-js"} text={"VTK.js"}/>.</p>
          <h4>Why does it exist?</h4>
          <p>To provide a simple starting point for developers that wish to build applications on top of VTK.js.
          </p>
        </div>
...
function Example(props) {
  return (
    <div className="container">
      <h5><Link to="/">Back to Examples</Link></h5>
      {props.children}
    </div>
  )
}
