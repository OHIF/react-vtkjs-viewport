...
class VTKMPRRotateExample extends Component {
  ...
  updateRotate = (index) => {
    ...
    istyle.rotate({ slicePlaneXRotation: volumeData[index].slicePlaneYRotation,
    ...
    <div className="row">
      ...
      <div className="row">
        ...
        <div><input
                  ...
                  onChange={(event) => {this.handleChangeX(0, event)}}
                />
            ...
            <div><input
                  ...
                  onChange={(event) => {this.handleChangeY(0, event)}}
                />
        ...
        <div><input
                  ...
                  onChange={(event) => {this.handleChangeX(1, event)}}
                />
            ...
            <div><input
                  ...
                  onChange={(event) => {this.handleChangeY(1, event)}}
                />
      ...
      <div className="row">
        ...
        <div><input
                  ...
                  onChange={(event) => {this.handleChangeX(2, event)}}
                />
            ...
            <div><input
                  ...
                  onChange={(event) => {this.handleChangeY(2, event)}}
                />
